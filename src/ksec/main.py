...
def build_parser() -> argparse.ArgumentParser:
    ...
    r_create.add_argument("--format", default="markdown", choices=["markdown", "html", "pdf"])
    ...
    r_preview.add_argument("--format", default="markdown", choices=["markdown", "html"])
    r_preview.set_defaults(func=report_commands.cmd_report_preview)
    r_export = r_sub.add_parser("export", help="Export a stored report as PDF", parents=[common_sub])
    r_export.add_argument("id", type=int)
    r_export.add_argument("--out", default=None, help="Output .pdf path")
